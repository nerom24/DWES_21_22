  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    @if (Auth::user()->hasAnyRole(['admin']))
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{ route('cuentas.create') }}">Nuevo <span class="sr-only">(current)</span></a>
      </li>
    ...
    <form class="form-inline mt-2 mt-md-0" action="{{route('cuentas.index')}}" method="GET" >
