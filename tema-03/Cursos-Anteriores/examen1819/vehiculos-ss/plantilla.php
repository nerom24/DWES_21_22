<?php 
		...
		<table class="table">
			...
			<tbody>
				<?php foreach ($tabla as $key =>$registro): ?>
					...
					<!-- Añadir Acciones disponibles configurar href-->
					<td>
	...
	<section>
		<form action="" method="POST">
			...
			<div class="form-group">
				<label for="">id</label>
				<input type="text" name="id" class="form-control" required="required" title="id" autofocus value="">
			</div>

			<div class="form-group">
				<label for="">Fabricante</label>
				<input type="text" name="fabricante" class="form-control" required="required" title="fabricante" value="">
			</div>

			<div class="form-group">
				<label for="">Modelo</label>
				<input type="text" name="modelo"  class="form-control" required="required" title="Modelo" value="">
			</div>
			...
			<div class="form-group">
				<label for="">Motor</label>
				<input type="text" name="motor"  class="form-control" required="required" title="Motor" value="">
			</div>

			<div class="form-group">
				<label for="">Precio</label>
				<input type="number" step="any" name="precio"  class="form-control" required="required" title="Precio" value="">
			</div>
