  ...
  <body>
    <div class="container">
      ...
      <div class="p-5 bg-light">
        <div class="container">
          <h1 class="display-3">Actividad 3.3.4 - Tema 3 PHP</h1>
          <p class="lead">Gestión Tabla de Libros</p>
          <hr class="my-2">
        </div>
      </div>
      ...
      <table class="table">
        ...
        <tbody>
          <?php foreach ($libros as $key => $libro): ?>
            ...
            <td><a href="eliminar.php?indice=<?=$key?>"><i class="bi bi-trash-fill"></i></a></td>
