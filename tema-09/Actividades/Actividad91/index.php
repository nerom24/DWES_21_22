...
<body>
	<header class="jumbotron text-center">
            <h1>Actividad 6.4 - Gestión Alumnos PDO</h1>
	...
	<div class="container">
		...
		<div class="row">		
			<div class="btn-group col-md-6" role="group" aria-label="...">
				...
				<button class="btn btn-default"><a href="procesarPdf.php">Pdf</a></button>
				<button class="btn btn-default" type="submit" name="btnBuscar" formaction="procesarEmail.php">Enviar Email</button>    
			</div>
			<div class="col-md-5">
				<div class="col-md-11">
		...
		<section>
			<article>
				<?php if (isset($_COOKIE['correo'])) {
					echo '<div class="alert alert-info alert-dismissable"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'.$_COOKIE['correo'].'</div>';
  					setcookie('correo',"",-1);
				} ?>		
