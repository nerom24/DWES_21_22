<?php
    ...
    public function edit($param) {
        ...
        $cuenta = $this->model->getCuenta($id_cuenta);

        # Cargamos los campos del formulario con los valores cuenta
        $this->view->id = $id_cuenta;
        $this->view->cliente_id = $cuenta->id_cliente;
        $this->view->num_cuenta = $cuenta->num_cuenta;
        $this->view->saldo = $cuenta->saldo;
        # Select de la tabla cuentas
        $this->view->clientes = $this->model->getClientesSelect();
    ...
    #
    # Validar editar cuenta
    #
    public function validate_edit($param) {
        ...
        $cliente_id = filter_var($_POST['cliente_id'],FILTER_SANITIZE_NUMBER_INT);
        $num_cuenta = filter_var($_POST['num_cuenta'],FILTER_SANITIZE_STRING);
        $saldo = filter_var($_POST['saldo'],FILTER_SANITIZE_STRING);
        ...
        # Validar num_cuenta
        # Sólo procede a la validación si se ha modificado
        ...
        if (!empty($errores)) {
            ...
            header("location:" .URL. "cuentas/edit/".$id_cuenta);

        } else {

            # Añade nueva cuenta
            $this->model->update($id_cuenta, $cliente_id, $num_cuenta, $saldo);       
            $_SESSION['mensaje'] = "Cuenta creada correctamente";
