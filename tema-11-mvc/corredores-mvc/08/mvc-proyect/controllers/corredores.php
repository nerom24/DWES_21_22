<?php
    ...
    class Corredores Extends Controller {
        ...
        function ordenar($param){
            ...
            // Extraigo el parametro del corredor por el que voy a ordenar
            $this->view->criterio = (int) htmlspecialchars($param[0]);

            // Llamo a la funcion order pasandole el parametro por que quiero que me ordene
        ...
        function buscar(){
            $this->view->expresion = $_GET['expresion'];
            $this->view->title = "Filtrar Corredores - Maratoon";
            $this->view->corredores = $this->model->filter($this->view->expresion);
            $this->view->render('corredores/main/index');
        }
