                        ...
                        <?php foreach ($this->cuentas as $cuenta): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" title="Movimientos"><i class="material-icons">edit</i></a>
                                    <a href="#" title="Movimientos"><i class="material-icons">visibility</i></a>
                                    <a href="#" title="Movimientos"><i class="material-icons">delete</i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
