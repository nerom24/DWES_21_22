                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control" name="password" value="<?= $this->password ?>" required autocomplete="new-password">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <a class="btn btn-secondary" href="access" role="button">Cancelar</a>
                                    <button type="reset" class="btn btn-secondary" >Reset</button>
                                    <button type="submit" formaction="valregister" class="btn btn-primary">Registrar</button>
                                </div>
                            </div>
                        </form>
                    </div>
