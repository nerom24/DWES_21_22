...
<?php 
/* 
	Módulo de plantillas Gestión Usuarios Con Sesiones

	Actividad 5.5 - Gestion de Usuarios con Sesiones
*/
...
function headerPlantilla () {
	...
	?>
		...
		<hgroup class="jumbotron text-center">
				<h1>Act. 5.5 Gestión Usuarios con Manejo de Sesiones</h1>
...
//<nav> Menú
function menuConLogin ( $usuarioLogeado) {
...
?>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <div class="collapse navbar-collapse" id="navbarText">
		    ...
		    <span class="navbar-item">		      
		        <a class="nav-link" href="logout.php">Bienvenido  .Desconectar</a>
		    </span>
		  </div>
	</nav>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <div class="collapse navbar-collapse" id="navbarText">
		    ...
		    <span class="navbar-item">
		        ...
		        <a class="nav-link" href="logout.php"><?=$pUsuario.' '; ?>Logout</a>
