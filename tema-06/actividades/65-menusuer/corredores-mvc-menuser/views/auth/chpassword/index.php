                        ...
                        <form method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-9 offset-sm-3">
                                    <button type="submit" class="btn btn-primary" formaction="<?=URL?>auth/vchpassword">Enviar</button>
                                    <a class="btn btn-secondary" href="<?=URL?>corredores" role="button">Cancelar</a>
