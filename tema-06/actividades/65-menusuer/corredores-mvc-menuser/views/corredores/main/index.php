					...
					<?php foreach ($this->corredores as $corredor): ?>
							<tr>
								...
								<div class="btn-group">
									...
									" href="<?= URL ?>corredores/editar/<?= $corredor->id?>" title="Editar">
									<i class="bi bi-pencil-square"></i></a>

									<!-- Eliminar -->
									<a class="btn btn-sm btn-danger 
									<?= (!in_array($_SESSION['id_rol'], $GLOBALS['eliminar'])) ? 'disabled': null?>
									" href="<?= URL ?>corredores/eliminar/<?= $corredor->id?>" title="Eliminar" onclick="return confirm('Confimar elimación del corredor')">
									<i class="bi bi-trash"></i></a>

									<!-- Mostrar -->
									<a class="btn btn-sm btn-success 
									<?= (!in_array($_SESSION['id_rol'], $GLOBALS['consultar'])) ? 'disabled': null?>
									" href="<?= URL ?>corredores/mostrar/<?= $corredor->id?>" title="Mostrar"><i class="bi bi-eye"></i></a>
