<?php
    ...
    # Obtener la categoria a partir id de categoria        
    public function getCategoria($id_categoria) {
        ...
        # Eliminar corredor   
        public function delete($id_corredor) {
        ...
        try {
               ...
               # Ejecutamos mediante prepare la consulta SQL
               $result= $conexion->prepare($deleteSQL);
               $result->bindParam(':id_corredor', $id_corredor, PDO::PARAM_INT);
               $result -> execute();
        ...
        public function validarId_categoria($id_categoria) {
                try {
                        $sql = "
        ...
        # Validar id_club
        public function validarId_club($id_club) {
                try {
                        $sql = "
                                SELECT * FROM clubs
                                WHERE id = :id_club
